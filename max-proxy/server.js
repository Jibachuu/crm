...
const srv = http.createServer(async (req, res) => {
  ...
  // Edit own message — opcode 67 (EDIT_MESSAGE, payload: { chatId, messageId, text, elements })
  ...
  // Delete own message — opcode 66 (DELETE_MESSAGE, payload: { chatId, messageIds, forMe })
