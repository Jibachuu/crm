...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const body = await req.json() as { email?: string; password?: string; full_name?: string; role?: string; is_active?: boolean; sip_number?: string; sip_login?: string; sip_password?: string; phone?: string };
  ...
  if (body.sip_login !== undefined) profileUpdate.sip_login = body.sip_login;
  if (body.sip_password !== undefined) profileUpdate.sip_password = body.sip_password;
