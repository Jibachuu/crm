...
<style>body{font-family:Arial,sans-serif;font-size:12px;margin:20mm 15mm;color:#000;line-height:1.5}table{border-collapse:collapse;width:100%}.items td,.items th{border:1px solid #000;padding:4px 8px;font-size:11px}.items th{text-align:center;font-weight:bold}.items .r{text-align:right}.items .c{text-align:center}.sign-block{margin-top:18px;position:relative;min-height:140px}.stamp{position:absolute;left:0;top:30px;width:140px;opacity:0.85}.signature{position:absolute;left:150px;top:5px;width:115px;opacity:0.9}@page{size:A4;margin:14mm 16mm}@media print{body{margin:0}p{orphans:3;widows:3}#printBtn{display:none!important}}</style></head><body>
