...
${isOffer ? `<!-- v89 (25.06.2026): Брендовая шапка только для счёт-оферты —
     в обычном счёте остаётся как было, без лого/слогана. -->
<div style="display:flex;align-items:flex-start;gap:24px;padding-bottom:12px;margin-bottom:14px;border-bottom:1px solid #ddd">
  <div style="font-size:32px;font-weight:300;color:#666;letter-spacing:4px;line-height:1;padding-top:4px">ARTEVO</div>
  ...
  <div style="font-size:10px;color:#555;line-height:1.55;text-align:right">
    Служба заботы: Пн-Пт 09:00-19:00<br>
    Телефон: +7 (843) 297-33-22<br>
    Почта: info@art-evo.ru
  </div>
</div>` : ""}
...
<!-- 2 колонки с column-fill:auto — заполняются последовательно (левая до
     низа, потом правая), без браузерной балансировки. Раньше использовался
     дефолтный column-fill:balance — он выравнивал высоту колонок и
     оставлял пустую зону сверху страницы 2, поэтому я временно перешёл
     на одну колонку. Сейчас вернули 2 колонки правильно по запросу
     Жибы 25.06.2026. break-inside:avoid на bold-параграфах-заголовках
     не даёт разрывать заголовок раздела от его первого пункта. -->
<div style="column-count:2;column-gap:24px;column-fill:auto;column-rule:1px solid #eee">
<p class="terms-heading" style="font-weight:bold;margin:4px 0 2px">1. Акцепт и заключение договора</p>
...
<p class="terms-heading" style="font-weight:bold;margin:6px 0 2px">2. Предмет поставки</p>
...
<p class="terms-heading" style="font-weight:bold;margin:6px 0 2px">3. Цена и порядок расчетов</p>
...
<p class="terms-heading" style="font-weight:bold;margin:6px 0 2px">4. Порядок поставки и переход права собственности</p>
...
<p class="terms-heading" style="font-weight:bold;margin:6px 0 2px">5. Приемка, качество, претензии</p>
...
<p class="terms-heading" style="font-weight:bold;margin:6px 0 2px">6. Документы и гарантия</p>
...
<p class="terms-heading" style="font-weight:bold;margin:6px 0 2px">7. Условия использования флаконов, емкостей, дозаторов и тары Havenberg / Artevo</p>
...
<p class="terms-heading" style="font-weight:bold;margin:6px 0 2px">8. Ответственность сторон</p>
